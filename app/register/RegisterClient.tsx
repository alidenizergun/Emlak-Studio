                ...
                <div className={styles.leftContent}>
                    ...
                    <ul className={styles.benefitsList}>
                        <li className={styles.benefitItem}>
                            ...
                            <div>
                                <h3>Profesyonel Görseller</h3>
                                <p>AI destekli 4K kalitesinde fotoğraf ve dekorasyon</p>
                            </div>
                        </li>
                        <li className={styles.benefitItem}>
                            <div className={styles.benefitIcon}>⚡</div>
                            <div>
                                <h3>5 Saniyede Hazır</h3>
                                <p>Manuel çalışmadan saniyeler içinde sonuç alın</p>
                            </div>
                        </li>
                        <li className={styles.benefitItem}>
                            <div className={styles.benefitIcon}>💰</div>
                            <div>
                                <h3>%80 Maliyet Tasarrufu</h3>
                                <p>Fotoğrafçı ve dekoratör maliyetlerinden kurtulun</p>
                            </div>
                        </li>
                        <li className={styles.benefitItem}>
                            <div className={styles.benefitIcon}>🏆</div>
                            <div>
                                <h3>10.000+ Kullanıcı</h3>
                                <p>Türkiye'nin en çok tercih edilen emlak AI platformu</p>
                            </div>
                        </li>
                    </ul>
