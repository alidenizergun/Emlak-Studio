                                ...
                                <div className={styles.popupCol}>
                                    <span className={`${styles.popupBadge} ${styles.popupBadgeAfter}`}>
                                        ...
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                                            <defs>
                                                <linearGradient id="ex_pop_paint_ai" x1="0%" y1="0%" x2="100%" y2="100%">
                                                    <stop offset="0%" stopColor="#10b981" />
                                                    <stop offset="100%" stopColor="#3b82f6" />
                                                </linearGradient>
                                            </defs>
                                            <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" fill="url(#ex_pop_paint_ai)" stroke="url(#ex_pop_paint_ai)" strokeWidth="1.2" strokeLinejoin="round" />
                                        </svg>
                                    </span>
